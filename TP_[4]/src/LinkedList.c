 ...
 * \return int Retorna  (-1) Error: si el puntero a la listas es NULL
                                ( 0) Si ok
 */
//orden: 0 descendente 1 ascendente
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    {
    	len=ll_len(this);
    	//si pFunc>0 (el primero es mayor al segundo) y el orden es ascendente(1) || si pFunc<0 (el primero es menor al segundo) y el orden es descendente(0)
    	for(i=0; i<len; i++)
    	{
    		for(j=i+1 ; j<len; j++)
    		{
